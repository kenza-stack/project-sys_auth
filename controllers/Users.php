    ...
    class Users {
        ...
        public function register(){
            ...
            if(strlen($data['usersPwd']) < 8){
                ...
                redirect("../signup.php");
            } else if(!preg_match("/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@$!%*?&]).{8,}$/", $data['usersPwd'])){
                flash("register", "Password must have at least 1 uppercase letter, 1 lowercase letter, 1 number, and 1 special character");
                redirect("../signup.php");
